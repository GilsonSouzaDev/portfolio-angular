...
ngAfterViewInit(): void {
    this.animation(this.cardAnimation1.nativeElement, this.container.nativeElement, 2, 10, -100);
    this.animation(this.cardAnimation2.nativeElement, this.container.nativeElement, 4, 10, 100);
    this.animation(this.cardAnimation3.nativeElement, this.container.nativeElement, 4, 10, -100);
    this.animation(this.cardAnimation4.nativeElement, this.container.nativeElement, 2, 10, 100);
}
